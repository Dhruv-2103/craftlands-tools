  ...
  return (
    <section class="flex mx-auto max-w-6xl px-6 items-center justify-center min-h-[calc(100svh)] pt-[12px] max-lg:pt-[10px]">
      <div class="my-10 min-h-[60px] w-full">
        {/* <div class="absolute mx-auto max-w-[1104px] max-h-80 max-lg:max-w-[968px] max-lg:top-44 top-32 inset-0 bg-gradient-to-t from-black to-transparent"/> */}
        <Minecraft class="w-full max-h-80 mix-blend-plus-darker mb-4"/>
        <h1 class="font-bold text-gray-50 text-4xl sm:text-4xl mb-2">
        ...
        <TextArea output id="anim-tab-output" class={{ 'min-h-52': true }} value={AnimationOutput(store)}>
        ...
        <h1 class={{
          'text-8xl sm:text-8xl max-sm:text-6xl my-4 break-all max-w-7xl -space-x-[1px] font-mc': true,
          'font-mc-bold': store.bold,
          'font-mc-italic': store.italic,
          'font-mc-bold-italic': store.bold && store.italic,
        }}>
          {(() => {
            const text = store.text != '' ? store.text : 'craftlands';
